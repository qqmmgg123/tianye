;(function(window, undefined) {
  ...
  var AudioPlayer = (function() {
      ...
      '            <i class="iconfont icon-bofang ap--play"></i>'+
      '            <i class="iconfont icon-pause ap--pause"></i>'+
      '        </button>'+
      ...
      '              <i class="iconfont icon-sound-mute ap--volume-off"></i>'+
      '              <i class="iconfont icon-sound- ap--volume-on"></i>'+
      '          </button>'+
      '          <div class="ap-volume">'+
      ...
      '          <i class="iconfont icon-round-repeat-px"></i>'+
      '        </button>'+
      '        <button class="ap-controls ap-playlist-btn">'+
      '          <i class="iconfont icon-queuemusic"></i>'+
      '        </button>'+
      '      </div>'+
      '    </div>'+
      '  </div>';
    ...
    function init(options) {
      ...
      playBtn.addEventListener('click', plToggleEmit, false);
      ...
      function renderPL() {
        ...
        var tpl =
          '<li data-track="{count}">'+
            '<div class="pl-number">'+
              '<div class="pl-count">'+
                '<i class="iconfont icon-audiotrack"></i>'+
              '</div>'+
   ...
   */
    ...
    function prev() {
      index = index - 1;
      play();
      settings.onPrev(index)
    }
  
    function next() {
      index = index + 1;
      play();
      settings.onNext(index)
    }
    ...
    function plToggleEmit() {
      playToggle()
      settings.onTogglePlay(index)
    }
